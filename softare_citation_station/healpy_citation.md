...
"healpy": {
    ...
    "category": "Cosmology",
    "keywords": [],
    "description": "healpy is a Python package to handle pixelated data on the sphere using the Hierarchical Equal Area isoLatitude Pixelization (HEALPix) scheme",
    "link": "https://healpy.readthedocs.io/",
    "attribution_link": "https://github.com/healpy/healpy/blob/main/CITATION",
    "zenodo_doi": "",
    "custom_citation": "Some of the results in this paper have been derived using the healpy and HEALPix packages",
    "dependencies": [
        "astropy",
        "matplotlib",
        "numpy",
